...
public class Main {
    public static void main(String[] args) {
        ...
        int count = 0;
        Monster test;
        while (count < countMonster) { // Исправлено: строго меньше
            if (r.nextBoolean()) {
        ...
        // Проверяем, что клетка для замка свободна
        ...
        switch (answer.toUpperCase()) { // Исправлено: приведение к верхнему регистру
            case "ДА" -> {
